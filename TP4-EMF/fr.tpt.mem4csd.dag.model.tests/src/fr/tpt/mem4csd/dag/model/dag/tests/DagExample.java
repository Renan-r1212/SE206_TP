...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dag</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DagExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dag"));
				DagSpecification root = DagFactory.eINSTANCE.createDagSpecification();

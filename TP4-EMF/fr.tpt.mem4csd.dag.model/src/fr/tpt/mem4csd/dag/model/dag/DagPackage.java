...
public interface DagPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CHANNEL__NAME = IDENTIFIED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CHANNEL__SOURCE_PORT = IDENTIFIED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int CHANNEL_FEATURE_COUNT = IDENTIFIED_ELEMENT_FEATURE_COUNT + 5;
